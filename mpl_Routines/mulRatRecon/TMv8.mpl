...
print("  SUMMARY"):
print("=================================================================="):
printf("%4s  %-15s  %8s  %8s  %12s  %12s  %12s  %14s  %14s\n",
       "n", "status",
       "BB-NDSA", "BB-MRFI",
       "t-NDSA(s)", "t-MRFI(s)", "t-BB(s)",
       "MRFI-wall(s)", "FFGE-total(s)"):
for entry in summary do
    printf("%4d  %-15s  %8d  %8d  %12.3f  %12.3f  %12.3f  %14.6f  %14.6f\n",
           entry[1], entry[2],
           entry[4], entry[5],
           entry[20], entry[21], entry[20] + entry[21],
           entry[22], entry[13]):
end do;
...
for entry in summary do
    ...
    fprintf(fd, "  Total BB time (NDSA+MRFI): %.9f\n",
            entry[20] + entry[21]):
    fprintf(fd, "  MRFI wall-clock (s)      : %.9f  (FULL solve: BB + symbolic work)\n",
            entry[22]):
