...
print("  SUMMARY"):
print("=================================================================="):
printf("%4s  %-15s  %10s  %12s  %12s  %14s\n",
       "n", "status", "BB-calls", "bb/call(s)", "bb-total(s)", "FFGE-total(s)"):
for entry in summary do
    printf("%4d  %-15s  %10d  %12.3e  %12.3f  %14.6f\n",
           entry[1], entry[2], entry[3], entry[4], entry[5], entry[13]):
end do;
